...
Deduplicate skills and plugins across instances, promote the identical ones into the shared trees, register them, remove the local copies that shadow them, and verify on four levels

Arguments: [selector] [--adopt-duplicates] [--restart] [--yes]
