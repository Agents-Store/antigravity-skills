...
Provider credential state across the fleet — classify every profile, print the logins a human must run, watch for expiry and account drift

Arguments: [selector] [--provider <id>] [--status] [--print-login] [--watch]
