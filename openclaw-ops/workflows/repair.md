...
The only repair funnel — dispatch one catalog finding id through its eight-block plan, apply on a later turn, verify

Arguments: <selector> --issue <finding-id> [--all-findings] [--yes]
