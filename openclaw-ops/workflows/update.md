...
Upgrade instances on a pinned, soaked target — baseline, verified backup, plan, apply, post-checks, schedule dedup

Arguments: <selector> [--to <version>] [--channel stable|extended-stable|beta|dev] [--yes]
