...
Full fleet audit in an isolated agent — one prioritised report with a ready repair line under every finding

Arguments: [selector] [--focus auth|versions|memory|cron|secrets|security|shared|all]
