...
CLAUDE.md Tech Stack section, enabledPlugins), reconcile `lifecycle.open_questions`
and `needs_from_client` pointers against `macstack/OPEN-QUESTIONS.md` and `roles[]`
against the USER-CASES.md role sections, run macstack-dev:lint, and remind the
