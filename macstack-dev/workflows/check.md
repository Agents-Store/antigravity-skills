...
Validate the spec and the documents, report where the project stands and what to run next, or audit the implementation against the documents

Arguments: --docs | --code | --new | (empty = spec + documents + dashboard)
