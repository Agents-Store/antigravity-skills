...
Create or repair a project's macstack/ folder and macstack.json — from nothing (a six-question interview), from an existing macstack.json, from an existing codebase, or by migrating an older layout

Arguments: project path | business request | (empty = design from scratch) | --migrate
