...
Create or repair a project's macstack/ folder and macstack.json — from an existing codebase, from a business request, or by migrating an older layout

Arguments: project path | business request | --migrate
