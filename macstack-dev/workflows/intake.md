...
Take in anything the client sends — a document, a returned review package, or a correction typed straight into this chat — and merge it through delta → ruling → apply

Arguments: file in inbox/ | what to change,in your own words | (empty = whatever is unprocessed)
