...
Take in client material — a document, a returned review package, a list of corrections — and merge it into macstack/ through the delta → gate → ruling → apply loop

Arguments: file in inbox/ | artifact URL | what to change
