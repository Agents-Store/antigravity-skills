...
Build the client review package from the client documents — a self-contained HTML file, a published artifact with comment threads, or both — and read the client's comments back

Arguments: --html | --artifact | --read <url> | (empty = both)
