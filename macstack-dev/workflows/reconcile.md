...
Sync the code and every document in one declared direction — the code is master and the documents get corrected, or the documents are master and the gaps become tasks

Arguments: --master=code | --master=docs [--dry] [--only <documents>]
