...
Close the loop after work — reconcile the spec with the code and the client documents, rebuild the generated documents, re-derive test cases, journal the work and curate the changelog

Arguments: --after M11-T9 | --release M11 | (empty = every task finished since the last work entry)
