...
1. Read the create skill at `./skills/create/SKILL.md`
...
3. Use references from `./skills/create/references/` for stack.json schema and level checklists
4. For design decisions, use the `template-architect` agent
5. Run validation at the end using `./skills/validate/SKILL.md`
