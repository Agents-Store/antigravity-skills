...
1. Read the audit-stack skill at `./skills/audit-stack/SKILL.md` — it contains the full 5-phase workflow
2. Read both reference files before starting the scan:
   - `./skills/audit-stack/references/technology-signatures.md`
   - `./skills/audit-stack/references/layer-classification.md`
